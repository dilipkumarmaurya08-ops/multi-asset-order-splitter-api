...
exports.orderIdSchema = exports.decimalPrecisionSchema = exports.orderQuerySchema = exports.createOrderSchema = void 0;
const zod_1 = require("zod");
const constants_1 = require("../config/constants");
/**
 * Asset type enum for validation
 */
const assetTypeEnum = zod_1.z.enum([
    constants_1.ASSET_TYPES.STOCK,
    constants_1.ASSET_TYPES.ETF,
    constants_1.ASSET_TYPES.CRYPTO,
    constants_1.ASSET_TYPES.COMMODITY,
    constants_1.ASSET_TYPES.BOND,
    constants_1.ASSET_TYPES.MUTUAL_FUND,
]);
/**
 ...
 */
const portfolioAssetSchema = zod_1.z.object({
    symbol: zod_1.z
        .string()
...
const portfolioSchema = zod_1.z.object({
    assets: zod_1.z
        ...
        .max(constants_1.ORDER_CONFIG.MAX_ASSETS_PER_PORTFOLIO, `Portfolio cannot contain more than ${constants_1.ORDER_CONFIG.MAX_ASSETS_PER_PORTFOLIO} assets`)
        .refine((assets) => {
...
exports.createOrderSchema = zod_1.z.object({
    orderType: zod_1.z.enum([constants_1.ORDER_TYPES.BUY, constants_1.ORDER_TYPES.SELL], {
        errorMap: () => ({ message: 'Order type must be either BUY or SELL' }),
    }),
    amount: zod_1.z
        .number()
        .min(constants_1.ORDER_CONFIG.MIN_ORDER_AMOUNT, `Amount must be at least $${constants_1.ORDER_CONFIG.MIN_ORDER_AMOUNT}`)
        .max(constants_1.ORDER_CONFIG.MAX_ORDER_AMOUNT, `Amount cannot exceed $${constants_1.ORDER_CONFIG.MAX_ORDER_AMOUNT}`)
        .finite('Amount must be a finite number')
        .optional(),
...
exports.orderQuerySchema = zod_1.z.object({
    orderType: zod_1.z.enum([constants_1.ORDER_TYPES.BUY, constants_1.ORDER_TYPES.SELL]).optional(),
    symbol: zod_1.z
        .string()
        .toUpperCase()
        .optional(),
 ...
 */
exports.decimalPrecisionSchema = zod_1.z.object({
    decimalPlaces: zod_1.z
        .number({
        ...
        .min(constants_1.ORDER_CONFIG.MIN_DECIMAL_PRECISION, `Decimal places must be at least ${constants_1.ORDER_CONFIG.MIN_DECIMAL_PRECISION}`)
        .max(constants_1.ORDER_CONFIG.MAX_DECIMAL_PRECISION, `Decimal places cannot exceed ${constants_1.ORDER_CONFIG.MAX_DECIMAL_PRECISION}`),
});
/**
